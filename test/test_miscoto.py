...
def test_instance():
    ...
    lp_instance = run_instance(model_host='../toy/orgA.xml', bacterium_met='../toy/symbionts/', seeds_sbml='../toy/seeds.xml', targets_sbml='../toy/targets_A.xml')
...
def test_mincom():
    ...
    results = run_mincom(draft_sbml='../toy/orgA.xml', bacterium_met='../toy/symbionts/', seeds_sbml='../toy/seeds.xml', targets_sbml='../toy/targets_A.xml', option='minexch')
...
def test_scopes():
    ...
    results = run_scopes(draft_sbml='../toy/orgA.xml', bacterium_met='../toy/symbionts/', seeds_sbml='../toy/seeds.xml', targets_sbml='../toy/targets_A.xml')
